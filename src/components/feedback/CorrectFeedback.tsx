...
export default function CorrectFeedback({ onDone }: CorrectFeedbackProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-emerald-600/15 backdrop-blur-sm animate-fade-in-up">
      <div className="bg-white rounded-2xl p-8 shadow-2xl text-center border border-emerald-300 animate-glow-green">
        <div className="w-16 h-16 rounded-full bg-[var(--color-success)] flex items-center justify-center mx-auto mb-3 shadow-[0_0_20px_rgba(56,161,105,0.4)] animate-bounce-in">
